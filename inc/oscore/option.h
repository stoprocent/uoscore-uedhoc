...
#define NO_RESPONSE_OPTION_CLASS_2 ( 0x02 ) // ( 0b00000010 ) Not interested in 2.xx responses
#define NO_RESPONSE_OPTION_CLASS_4 ( 0x08 ) // ( 0b00001000 ) Not interested in 4.xx responses
#define NO_RESPONSE_OPTION_CLASS_5 ( 0x10 ) // ( 0b00010000 ) Not interested in 5.xx responses
